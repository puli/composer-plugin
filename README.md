...
In your classes, pass the locator to the methods that need it or 
inject it via the constructor or a setter of the class:
...
class ConfigFileLoader
{
    ...
    {
        $realPath = $this->locator->get($path)->getRealPath();
...
The application developer that uses your package can then pass the
resource locator generated by the plugin to your classes.
